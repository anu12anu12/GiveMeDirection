...
class ElementArrayParameter extends TemplateParameter
{
  ...
  public ElementArrayParameter(Constructor paramConstructor, ElementArray paramElementArray, Format paramFormat, int paramInt)
    throws Exception
  {
    Contact localContact1 = new Contact(paramElementArray, paramConstructor, paramInt);
    this.contact = localContact1;
    Contact localContact2 = this.contact;
    ElementArrayLabel localElementArrayLabel = new ElementArrayLabel(localContact2, paramElementArray, paramFormat);
    this.label = localElementArrayLabel;
