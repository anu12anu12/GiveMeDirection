...
class ElementUnionParameter extends TemplateParameter
{
  ...
  public ElementUnionParameter(Constructor paramConstructor, ElementUnion paramElementUnion, Element paramElement, Format paramFormat, int paramInt)
    throws Exception
  {
    Contact localContact1 = new Contact(paramElement, paramConstructor, paramInt);
    this.contact = localContact1;
    Contact localContact2 = this.contact;
    ElementUnionLabel localElementUnionLabel = new ElementUnionLabel(localContact2, paramElementUnion, paramElement, paramFormat);
    this.label = localElementUnionLabel;
